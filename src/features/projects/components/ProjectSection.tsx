    ...
    >
      <div className="space-y-12 sm:space-y-16">
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <Link
            href="/project"
            className="inline-flex items-center gap-3 rounded-full border-dotted-thick border-border px-6 py-3 text-sm uppercase tracking-[0.3em] transition-interface duration-300 hover:-translate-y-1 hover:bg-foreground hover:text-background"
          >
            View All
            <svg
              className="h-4 w-4"
...
function FeatureCard({ project }: FeatureCardProps) {
  return (
    <article className="magnet-card rounded-3xl flex h-full flex-col gap-4 border-pulse-animated border-border p-6 transition-interface duration-500 hover:-translate-y-1 hover:shadow-2xl bg-card/50 backdrop-blur-sm">
